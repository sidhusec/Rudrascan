# Contributing to RudraScan

Thank you for your interest in contributing to RudraScan! This guide covers everything you need to get started.
...
1. **Fork and clone** the repository:
   ...
   ```bash
   git clone https://github.com/<your-username>/rudrascan
   cd rudrascan
...
```
rudrascan/
├── rudrascan.sh              # Entry point (~536 lines) — arg parsing, module loading, dispatch
├── rudrascan.cfg             # Default configuration file
...
3. **Add a config toggle** in `rudrascan.cfg`:
...
2. Add configuration variables to `rudrascan.cfg`
...
- Group related variables together in `rudrascan.cfg`
...
3. **Integration Tests** — installs RudraScan and runs tool checks
...
Submit bugs via [GitHub Issues](https://github.com/six2dez/rudrascan/issues/new/choose). Include:

- RudraScan version (`git describe --tags`)
...
Open a [GitHub Issue](https://github.com/six2dez/rudrascan/issues/new/choose) with:
